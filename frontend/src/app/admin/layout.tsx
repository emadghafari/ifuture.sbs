            ...
            <aside className={`w-64 bg-[#0B1120] text-slate-300 flex flex-col fixed inset-y-0 z-50 transform md:translate-x-0 transition-transform duration-300 ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full'}`}>
                ...
                <div className="flex items-center justify-between px-6 py-5 border-b border-slate-800/50">
                    <div className="flex items-center gap-3 cursor-pointer hover:text-white hover:scale-105 transition-all duration-300">
                        <div className="w-6 h-6 bg-slate-700 rounded flex items-center justify-center text-xs shadow-sm">👥</div>
                ...
                <div className="flex-1 overflow-y-auto px-4 py-6 scrollbar-hide">
                    ...
                    <div className="mb-6">
                        ...
                        <nav className="space-y-1">
                            <Link href="/admin/dashboard" className={`flex items-center space-x-3 px-3 py-2 rounded-lg text-sm transition-all duration-300 hover:scale-[1.02] active:scale-95 ${pathname === '/admin/dashboard' ? 'bg-[#1E293B] text-white font-medium shadow-md' : 'text-slate-400 hover:text-white hover:bg-slate-800/50 hover:translate-x-1'}`}>
                    ...
                    <div className="mb-6">
                        ...
                        <nav className="space-y-1">
                            <Link href="/admin/products" className={`flex items-center space-x-3 px-3 py-2 rounded-lg text-sm transition-all duration-300 hover:scale-[1.02] active:scale-95 ${pathname === '/admin/products' ? 'bg-[#1E293B] text-white font-medium shadow-md' : 'text-slate-400 hover:text-white hover:bg-slate-800/50 hover:translate-x-1'}`}>
                            ...
                            <Link href="/admin/team" className={`flex items-center space-x-3 px-3 py-2 rounded-lg text-sm transition-all duration-300 hover:scale-[1.02] active:scale-95 ${pathname === '/admin/team' ? 'bg-[#1E293B] text-white font-medium shadow-md' : 'text-slate-400 hover:text-white hover:bg-slate-800/50 hover:translate-x-1'}`}>
                    ...
                    <div className="mb-6">
                        ...
                        <nav className="space-y-1">
                            <Link href="/admin/settings" className={`flex items-center space-x-3 px-3 py-2 rounded-lg text-sm transition-all duration-300 hover:scale-[1.02] active:scale-95 ${pathname === '/admin/settings' ? 'bg-[#1E293B] text-white font-medium shadow-md' : 'text-slate-400 hover:text-white hover:bg-slate-800/50 hover:translate-x-1'}`}>
                ...
                <div className="p-4 border-t border-slate-800/50">
                    <div className="flex items-center space-x-3 p-2 rounded-lg hover:bg-slate-800/50 transition-colors cursor-pointer">
                        <div className="w-8 h-8 rounded-full bg-gradient-to-tr from-blue-500 to-indigo-500 flex items-center justify-center text-white font-bold text-xs ring-2 ring-slate-800">
                            {user?.name.charAt(0)}
                        </div>
            ...
            <main className="flex-1 md:ml-64 min-h-screen w-full md:w-auto bg-white shadow-[-10px_0_15px_-3px_rgba(0,0,0,0.1)] z-10 relative">
                ...
                <div className="absolute top-6 right-6 md:right-10 flex items-center gap-4 md:gap-6 z-[100]">
                    ...
                    <div className="relative">
                        ...
                        {isBellOpen && (
                            <div className="absolute right-0 mt-3 w-80 bg-white rounded-xl shadow-xl border border-slate-100 overflow-hidden text-sm">
                                ...
                                <div className="p-4 space-y-4">
                                    <div className="flex gap-3">
                                        ...
                                        <div>
                                            <p className="text-slate-800 font-medium leading-tight">System Initialization Complete</p>
                                            <p className="text-slate-500 text-xs mt-1">iFuture Hub v2.0 is live.</p>
                                        </div>
                                    </div>
                                    <div className="flex gap-3">
                                        <div className="w-2 h-2 mt-1.5 rounded-full bg-emerald-500"></div>
                                        <div>
                                            <p className="text-slate-800 font-medium leading-tight">Settings Synchronized</p>
                                            <p className="text-slate-500 text-xs mt-1">Database seeded with default values.</p>
                                        </div>
                                    </div>
                                </div>
                                <div className="px-4 py-3 border-t border-slate-100 text-center text-indigo-600 font-medium hover:bg-slate-50 cursor-pointer">
                                    View all activity
                                </div>
                            </div>
                        )}
                    ...
                    <div className="relative">
                        ...
                        {isProfileOpen && (
                            <div className="absolute right-0 mt-3 w-56 bg-white rounded-xl shadow-xl border border-slate-100 overflow-hidden text-sm">
                                <div className="px-4 py-3 border-b border-slate-100 bg-slate-50">
                                    <p className="font-bold text-slate-800">{user?.name}</p>
                                    <p className="text-xs text-slate-500 truncate">{user?.email}</p>
                                </div>
                                <div className="py-2">
                                    <Link href="/admin/settings" className="flex items-center px-4 py-2 text-slate-600 hover:bg-slate-50 hover:text-indigo-600 transition-colors cursor-pointer font-medium">
