        ...
        <section className="py-32 bg-[#030a08] relative border-t border-white/5">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="text-center mb-20">
                    <h2 className="text-[3rem] sm:text-[4rem] font-bold text-white tracking-tight mb-6 leading-[1.1]">
                        {t('founder.title')}
                    </h2>
                ...
                <div className="flex flex-wrap justify-center gap-6 max-w-5xl mx-auto">
                    <div className="group bg-[#06120e] border border-white/5 rounded-3xl p-8 flex flex-col items-center gap-6 hover:border-primary-500/30 hover:bg-[#0a1b15] transition-all duration-300 transform hover:-translate-y-2 overflow-hidden relative w-full sm:w-64">

                        <div className="w-32 h-32 rounded-full bg-[#11241d] border-4 border-white/5 flex items-center justify-center font-bold text-5xl relative z-10 overflow-hidden shadow-2xl group-hover:border-primary-500/30 transition-colors">
                            🧔🏻‍♂️
                        </div>

                        <div className="text-center relative z-10">
                            <h3 className="text-lg font-bold text-white tracking-wide mb-1">{t('founder.name')}</h3>
                            <p className="text-xs font-medium text-primary-400 uppercase tracking-widest">{t('founder.title')}</p>
                        </div>
            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="bg-[#050f0c] border border-white/10 rounded-[2.5rem] p-12 lg:p-24 overflow-hidden relative shadow-[0_20px_50px_rgba(0,0,0,0.5)]">
                    ...
                    <div className="relative z-10 text-center max-w-3xl mx-auto flex flex-col items-center">
                        ...
                        <p className="text-lg text-slate-400 font-medium mb-12 max-w-xl leading-relaxed whitespace-pre-wrap">
                            {t('investors.text')}
                        </p>

                        <a href="/portal/login" className="group relative inline-flex items-center gap-3 px-8 py-4 font-bold text-white transition-all bg-primary-600 rounded-full hover:bg-primary-500 shadow-[0_0_30px_rgba(4,120,87,0.3)] hover:shadow-[0_0_40px_rgba(4,120,87,0.5)] overflow-hidden transform hover:scale-105">
                            <span className="relative z-10">{t('investors.cta')}</span>
