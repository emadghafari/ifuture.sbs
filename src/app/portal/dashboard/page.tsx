                                        ...
                                        <div className="p-8 md:w-2/3 flex flex-col justify-between relative z-10">
                                            <div>
                                                ...
                                                {inv.contract_pdf_path && (
                                                    <div className="mb-6">
                                                        <a href={inv.contract_pdf_path.startsWith('http') ? inv.contract_pdf_path : `https://api.ifuture.sbs/api/public/contracts/${inv.contract_pdf_path.split('/').pop()}`} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-4 py-2 bg-slate-800 hover:bg-slate-700 text-slate-200 text-sm font-bold rounded-xl transition-colors border border-slate-700">
